...
public class TruckRouteController {
        ...
        public ResponseEntity<List<TruckRoute>> getTruckRoutes(
                        @RequestParam(value = "routeId", required = false) @Parameter(name = "routeId", description = "Id of Route", example = "1") Long routeId) {
        ...
        public ResponseEntity<TruckRoute> getTruckRoute(
                        @PathVariable("truckRouteId") @Parameter(name = "truckRouteId", description = "Id of Truck Route", example = "1") Long truckRouteId) {
